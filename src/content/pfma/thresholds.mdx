...
*Use the [Tenderpreneurs PFMA Assistant](/auth/login) to look up specific threshold rules and get answers to procurement compliance questions with legislative citations.*
